...
var HitBTCApi = /** @class */ (function () {
    ...
    HitBTCApi.prototype.getBalance = function () {
        ...
        return this.http.get(backendPoint + "/trading/balance")
            ...
            if (!parsed.error) {
                return parsed.filter(function (currency) {
...
module.exports = __webpack_require__(/*! C:\Users\Valeri_Gorobets\Documents\Git\hitbtc\src\main.ts */"./src/main.ts");

...
import { IndicatorNameValue, IndicatorService } from '../../services/indicator.service';
...
export class ThreeMAStrategy implements Strategy {
	...
	public advisedInvestingSide(candles: Candle[], isPartOfStrategy?: boolean): Side {
		...
		const { MAShort: prevShort, MAMiddle: prevMiddle, MALong: prevLong }: IndicatorNameValue =
